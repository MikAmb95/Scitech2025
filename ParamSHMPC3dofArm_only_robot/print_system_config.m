...
xc=x(1,:)+2.2; %x_base
yc=x(2,:)+0.3; %y_base
psi=x(3,:)+deg2rad(45); %orient_base
q1=-x(4,:)+deg2rad(90); %q1 robot
q2=-x(5,:)+deg2rad(-90); %q2 robot
q3=x(6,:)+deg2rad(-90); %q3 robot
...
plot(xe3(1),ye3(1),'or',xe3(end),ye3(end),'*k','LineWidth',10)
